    ...
    <div class="card static panel">
      ...
      <form method="post" action="login.php" data-validate>
        <div class="field">
          ...
          <input type="email" id="email" name="email" value="<?php echo e($old_email); ?>" data-required data-label="Email" placeholder="you@email.com">
        </div>
        <div class="field">
          <label for="password">Password</label>
          <input type="password" id="password" name="password" data-required data-label="Password" placeholder="Your password">
        </div>
